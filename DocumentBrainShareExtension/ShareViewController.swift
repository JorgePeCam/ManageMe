...
private enum ShareExtensionConfig {
    static let appGroupIdentifier = "group.Jorge-Perez-Campos.DocumentBrain"
...
final class ShareViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        statusLabel.text = "Guardando en DocumentBrain…"
    ...
    private func showSuccess(result: ShareImportResult) {
        ...
        detailLabel.text = "Abre DocumentBrain para procesarlos\n\(typeSummary)"
    }
    ...
    private func showEmpty() {
        ...
        detailLabel.text = "DocumentBrain acepta PDFs, imágenes, documentos Word, Excel y texto"
    }
