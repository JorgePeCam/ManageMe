...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    var onboardingSubtitle1: String {
        switch self {
        case .spanish: return "Guarda facturas, garantías, contratos y cualquier documento importante. ManageMe los organiza y los tiene siempre listos para ti."
        case .english: return "Store invoices, warranties, contracts, and any important documents. ManageMe organizes them and keeps them ready for you."
        }
    }
